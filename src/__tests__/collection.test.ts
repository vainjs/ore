import { isEqual } from '../collection'
...
describe('isEqual', () => {
  ...
  test('should return true for same RegExp', () => {
  ...
  test('should return false for different RegExp', () => {
